    ...
    <div className="h-screen bg-slate-950 text-white flex flex-col">
      ...
      <div className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-sm flex-shrink-0">
        <div className="px-6 py-3 flex items-center gap-4">
          <Link to="/#claudecode" className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
            <ArrowLeft className="w-5 h-5" />
            <span>返回首页</span>
          </Link>
          <span className="text-slate-600">|</span>
          <h1 className="text-xl font-bold text-orange-400">Claude Code 实战演示</h1>
        </div>
      </div>
      {/* 空白区域 */}
